...
class Seq2SeqAdvLoss(torch.nn.Module):
    ...
    def __init__(self, bce_pos_weight=10.0):
        ...
        """
        super(Seq2SeqAdvLoss, self).__init__()
    ...
    def forward(self, after_outs, before_outs, logits, ys, labels, olens, encodedfeatures, accentlabels):
        ...
        adv_loss = self.adversarial_loss(encodedfeatures, accentlabels)

        return l1_loss, bce_loss, adv_loss
